    ...
    <header class="card-header d-md-flex align-items-center">
        ...
        <ul id="overallIncomeTabsControl" class="nav nav-tabs card-header-tabs ml-md-auto mt-3 mt-md-0">
            <li class="nav-item mr-4">
                <a class="nav-link active" href="index.html#overallIncomeTab1" role="tab" aria-selected="true" data-toggle="tab">
                    <span class="d-none d-md-inline">Last</span>
                    7 days
                </a>
            </li>
            <li class="nav-item mr-4">
                <a class="nav-link" href="index.html#overallIncomeTab2" role="tab" aria-selected="false" data-toggle="tab">
                    <span class="d-none d-md-inline">Last</span>
                    30 days
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="index.html#overallIncomeTab3" role="tab" aria-selected="false" data-toggle="tab">
                    <span class="d-none d-md-inline">Last</span>
                    90 days
                </a>
            </li>
            ...
            <div class="tab-pane fade show active" id="overallIncomeTab1" role="tabpanel">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <a class="btn btn-block btn-outline-primary" href="index.html#">Learn More</a>
                    </div>
                </div>
            </div>
            <!-- End Tab Content -->
    ...
    <div class="col-md-6 mb-4 mb-md-0">
        <div class="card h-100">
            <header class="card-header d-flex align-items-center">
                ...
                <ul class="list-inline ml-auto mb-0">
                    <li class="list-inline-item mr-3">
                        <a class="link-muted h3" href="index.html#!">
            ...
            <footer class="card-footer">
                <a class="u-link u-link--primary" href="index.html#!">All projects</a>
            </footer>
        </div>
    </div>
        ...
        <div class="card h-100">
            <header class="card-header d-md-flex align-items-center">
                ...
                <ul id="commentsTabsControl" class="nav nav-tabs card-header-tabs ml-md-auto mt-4 mt-md-0">
                    <li class="nav-item">
                        <a class="nav-link active" href="index.html#commentsTab1" role="tab" aria-selected="true"
                           data-toggle="tab">Pending
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.html#commentsTab2" role="tab" aria-selected="false"
            ...
            <footer class="card-footer">
                <a class="u-link u-link--primary" href="index.html#!">All comments</a>
            </footer>
        </div>
    </div>
    <!-- End Comments -->
