                    ...
                    <div class="site-footer-above-section-1 site-footer-section site-footer-section-1">
                        <aside class="footer-widget-area widget-area site-footer-focus-item" data-section="sidebar-widgets-footer-widget-1">
                            <div class="footer-widget-area-inner site-info-inner">
                                <section id="media_image-3" class="widget widget_media_image"><img width="160" height="100" src="<?= config::logo_white() ?>" class="image wp-image-90  attachment-thumbnail size-thumbnail" alt="Logo Regular" loading="lazy" style="max-width: 100%; height: auto;" srcset="<?= config::logo_white() ?> 1x, <?= config::logo_white() ?> 2x" /></section><section id="text-3" class="widget widget_text"> <div class="textwidget"><p>We envision a more just and peaceful lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec.</p>
                                    </div>
